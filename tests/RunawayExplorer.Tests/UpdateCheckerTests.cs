...
public class RepositoryUrlsTests
{
    ...
    {
        Assert.Equal(
            "https://github.com/Victor-Gomez/Runaway-Explorer",
            RepositoryUrls.Home("https://api.github.com/repos/Victor-Gomez/Runaway-Explorer/releases/latest"));
    }
    ...
    {
        Assert.Equal("https://github.com/Victor-Gomez/Runaway-Explorer", RepositoryUrls.Home(feedUrl));
    }
