...
/// <summary>
/// Owns a single fixed scratch directory (<c>RunawayExplorer/</c> under the OS temp folder) that every extracted sound/video/PNG
...
{
    public string ScratchDirectory { get; } = Path.Combine(Path.GetTempPath(), "RunawayExplorer");
