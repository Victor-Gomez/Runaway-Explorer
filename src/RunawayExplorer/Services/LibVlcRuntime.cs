...
public static class LibVlcRuntime
{
    ...
    {
        // Fully qualified: unqualified "Core" resolves to the sibling RunawayExplorer.Core namespace
        // instead of LibVLCSharp.Shared.Core here, since both share the enclosing RunawayExplorer namespace.
