...
/// <summary>
/// Help &gt; About. Doubles as the app's diagnostics panel: alongside the version it reports whether
/// LibVLC actually resolved, since that is the usual reason a sound or video silently does nothing, and
/// "Copy Diagnostics" puts the lot on the clipboard for a bug report.
/// </summary>
public sealed partial class AboutWindow : Window
{
    ...
    private async void CopyDiagnostics_Click(object? sender, RoutedEventArgs e)
    {
        var report = new StringBuilder()
            .AppendLine($"Runaway Explorer {AppInfo.InformationalVersion}")
